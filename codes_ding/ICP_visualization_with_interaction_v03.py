...
#parameters
model_path = r'C:\Users\dings\DocumentsMasterarbeit\models'
...
if __name__ == "__main__":
    ...
    #----quick show----:
    #registed_source,target = uti.icp_algo_quick(source=down_sample_source, target=target, threshold=threshold, trans_init=trans_init)
    ...
    #----segmentation----:
    #print("segmentieren...")
    #o3d.visualization.draw_geometries_with_editing([target+registed_source])
